package com.xiobit.petstore;

import com.xiobit.petstore.config.ApplicationProperties;
import com.xiobit.petstore.config.DefaultProfileUtil;
...
public class PetstoreApp {
    ...
    public PetstoreApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes petstore.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PetstoreApp.class);
